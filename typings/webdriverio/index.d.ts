...
declare namespace Hermione {
    export interface Browser<T> extends WebdriverIO.Client<T> {
        getMeta(): Browser<Hermione.BrowserMeta>;
        getMeta(key: string): Browser<unknown>;

        setMeta(key: string, value: unknown): Browser<void>;

        extendOptions(opts: {[name: string]: unknown}): Browser<void>;
         ...
         */
        assertView(state: string, selectors: string | Array<string>, opts?: Hermione.AssertViewOpts): Browser<void>;
    }
}
